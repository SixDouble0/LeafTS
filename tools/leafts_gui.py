...
FAMILY_META: dict[str, dict] = {
    "STM32L4": {"fn": "stm32l4_flash_init", "h": "hal_stm32l4_flash.h", "c": "hal_stm32l4_flash.c"},
    "STM32F1": {"fn": "stm32f1_flash_init", "h": "hal_stm32f1_flash.h", "c": "hal_stm32f1_flash.c"},
    "STM32F4": {"fn": "stm32f4_flash_init", "h": "hal_stm32f4_flash.h", "c": "hal_stm32f4_flash.c"},
    "STM32F7": {"fn": "stm32f7_flash_init", "h": "hal_stm32f7_flash.h", "c": "hal_stm32f7_flash.c"},
    "STM32H7": {"fn": "stm32h7_flash_init", "h": "hal_stm32h7_flash.h", "c": "hal_stm32h7_flash.c"},
    "STM32G0": {"fn": "stm32g0_flash_init", "h": "hal_stm32g0_flash.h", "c": "hal_stm32g0_flash.c"},
    "STM32G4": {"fn": "stm32g4_flash_init", "h": "hal_stm32g4_flash.h", "c": "hal_stm32g4_flash.c"},
    "STM32WB": {"fn": "stm32wb_flash_init", "h": "hal_stm32wb_flash.h", "c": "hal_stm32wb_flash.c"},
    "nRF52":   {"fn": "nrf52_flash_init",   "h": "hal_nrf52_flash.h",  "c": "hal_nrf52_flash.c"},
    "RP2040":  {"fn": "rp2040_flash_init",  "h": "hal_rp2040_flash.h", "c": "hal_rp2040_flash.c"},
    "ESP32":   {"fn": "esp32_flash_init",   "h": "hal_esp32_flash.h",  "c": "hal_esp32_flash.c"},
...
def make_main_c(b: dict) -> str:
    ...
    return (
        f'// Generated by LeafTS Playground\n'
        f'// Board  : {b["name"]}\n'
...
class BoardPanel(QWidget):
    ...
    def _build_ui(self):
        ...
        title = QLabel("LeafTS Playground")
