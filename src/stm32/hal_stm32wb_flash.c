// STM32WB Flash HAL for LeafTS
// Reference: RM0434 (STM32WB55/WB35/WB15/WB10)
//
// Similar to STM32WL flash controller but with 4 KB pages (vs 2 KB).
// FLASH_REG_BASE = 0x58004000 (CPU1 access, same base as STM32WL).
// Page count: up to 256 pages × 4 KB = 1 MB for WB55.
...
#define CR_PER      (1UL <<  1)
#define CR_PNB_POS  3
#define CR_PNB_MASK (0xFFUL << CR_PNB_POS)  // 8-bit page number
#define CR_STRT     (1UL << 16)
#define CR_LOCK     (1UL << 31)

#define FLASH_KEY1  0x45670123UL
#define FLASH_KEY2  0xCDEF89ABUL
#define PAGE_SIZE_BYTES  4096u   // 4 KB pages
...
static int wb_erase(uint32_t sector_address) {
